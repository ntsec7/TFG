...
Dependiendo de tu tipo de usuario podrás acceder a distintas pantallas violetas. Un usuario normal no podrá acceder a la pantalla \textit{Lista de usuarios}, por su parte un administrador no dispondrá de las pantallas \textit{Modo individual} y \textit{Notificaciones}. \\
