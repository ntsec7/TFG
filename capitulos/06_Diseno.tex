...
\section{Diseño de interfaces de usuario}
    ...
    Se exponen ahora en las Figuras \ref{fig:diupantallasiniciales}, \ref{fig:diupantallasgrupos}, \ref{fig:diugrouphistory}, \ref{fig:diusinglehistorygroup}, \ref{fig:diunotifications}, \ref{fig:diuperfil}, \ref{fig:diudecision}, \ref{fig:diuvotes}, \ref{fig:diudecisionwatch} y \ref{fig:diuadmin} los bocetos que representan el estado final de la aplicación. \\
    ...
    \begin{figure}
        ...
        \begin{subfigure}[ht]{0.3\textwidth}
            ...
            \caption{Cambiar el tipo}
            \label{fig:diucdec2}
        \end{subfigure}
         \hfill % Espacio elástico entre imágenes
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Crear Decision Cientifica.png}
            \caption{Científica}
            \label{fig:diudecisionscientific}
        \end{subfigure}
         \hfill % Espacio elástico entre imágenes
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Crear Decision Ruleta.png}
            \caption{Ruleta}
            \label{fig:diudecisionrulete}
        \end{subfigure}
        \caption{Crear una decisión}
    ...
    \begin{figure}
        ...
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Voto Científica.png}
            \caption{Científica criterios}
            \label{fig:diuscientificcriterion}
        \end{subfigure}
         \hfill % Espacio elástico entre imágenes
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Voto Científica 2.png}
            \caption{Científica opciones}
            \label{fig:diuscientificopinions}
        \end{subfigure}
         \hfill % Espacio elástico entre imágenes
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
        ...
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Voto Votación Ver Opción.png}
            \caption{Ver una opción}
            \label{fig:diuvoteopcion}
        \end{subfigure}
        \caption{Votar}
        \label{fig:diuvotes}
    \end{figure}
    ...
    \begin{figure}
        ...
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Crear Decision Predeterminada Cine (1).png}
            \caption{Crearla}
        ...
        \begin{subfigure}[ht]{0.3\textwidth}
            \centering
            \includegraphics[width=\textwidth]{figuras/diu/Decision Predeterminada Cine.png}
            \caption{Votar}
