...
\section{Agrupamiento de las historias de usuario}

A continuación se muestran las historias de usuario agrupadas en bloques lógicos:

\begin{itemize}
\item \textbf{Gestión de cuenta de cliente:} HU1, HU2, HU3, HU4 y HU5.
\item \textbf{Gestión de grupos:} HU6, HU7, HU8 y HU9, 
\item \textbf{Gestión de votaciones:} HU10, HU11, HU12, HU13, HU14, HU15, HU16, HU17, HU18 y HU19.
\item \textbf{Gestión de imágenes:} HU20.
\item \textbf{Gestión del administrador:} HU21, HU22, HU23, HU24, HU25, HU26, HU27, HU28, HU29, HU30, HU31 y HU32.
\end{itemize}
...
\begin{longtable}{>{\centering\arraybackslash}m{2cm} >{\centering\arraybackslash}m{2cm}}
\toprule
\rowcolor{grisfila}
\textbf{Código} & \textbf{Prioridad}\\
\midrule
HU 1 & 1 \\
HU 21 & 2 \\
HU 4 & 3\\
...
\begin{hu_card}{1}{Como cliente quiero poder crearme un perfil para poder usar la aplicación}
    ...
    \vspace{2mm}
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item El sistema no permitirá el registro de usuarios con un correo electrónico ya existente en la base de datos.
        \item El sistema validará que el correo electrónico introducido cumple el formato estándar.
        \item El nombre de usuario no podrá estar repetido en el sistema.
...
%2
\begin{hu_card}{2}{Como cliente quiero poder editar mi perfil para modificar mis datos}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 7 \\
...
\begin{hu_card}{3}{Como cliente quiero poder eliminar mi perfil para eliminar mis datos de la aplicación}
    ...
    \begin{itemize}[noitemsep, topsep=0pt]
        ...
        \item Eliminar la cuenta y sus datos asociados de la base de datos.
    \end{itemize}
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Los datos asociados de la cuenta se borran del sistema.
    \end{enumerate}
\end{hu_card}

%4
\begin{hu_card}{4}{Como cliente quiero poder iniciar sesión en la aplicación para acceder a sus funcionalidades}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 3 \\
        \textbf{Estimación:}  & 1 PH \\
...
%5
\begin{hu_card}{5}{Como cliente quiero poder cerrar sesión en la aplicación para que nadie más pueda acceder a mi cuenta}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 4 \\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ23\\
...
\begin{hu_card}{6}{Como cliente quiero poder crear un grupo para tomar decisiones con mis amigos}
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Se guarda en el sistema al creador del grupo como miembro de él.
    \end{enumerate}
\end{hu_card}
...
\begin{hu_card}{7}{Como cliente quiero poder abandonar un grupo para dejar de formar parte de él}
    ...
    \textbf{Descripción Detallada:} \\
    Un cliente podrá abandonar cualquiera de los grupos de los cuales forma parte, dejándole de salir en la interfaz de grupos a los que pertenece.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Si es el último miembro que formaba parte del grupo se elimina automáticamente el grupo y sus datos asociados.
    \end{enumerate}
\end{hu_card}
...
\begin{hu_card}{8}{Como cliente quiero poder añadir miembros a un grupo para añadirlos en la toma de decisiones}
    ...
    \begin{itemize}[noitemsep, topsep=0pt]
        ...
        \item Se actualiza la interfaz de la lista de grupos al nuevo miembro.
        \item Se guarda la relación entre el nuevo miembro y el grupo en el sistema.
    \end{itemize}

    \vspace{2mm}
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item Si intentas añadir a un cliente que ya pertenece al grupo te saldrá un mensaje de error.
...
\begin{hu_card}{9}{Como cliente quiero poder eliminar miembros de un grupo para que dejen de formar parte del grupo}
    ...
    \textbf{Descripción Detallada:} \\
    Un miembro de un grupo podrá eliminar a otro miembro del mismo, dejando de formar parte de él hasta que un usuario perteneciente al mismo volvierá a añadirlo.
...
\begin{hu_card}{10}{Como cliente quiero poder iniciar una votación para tomar una decisión}
    ...
    \textbf{Descripción Detallada:} \\
    Un cliente podrá crear una votación de manera personal o en un grupo del que forma parte, siendo la decisión pública para todos los miembros del grupo. La votación contará con un título, una lista de opciones y el tipo de votación.
...
\begin{hu_card}{11}{Como cliente quiero asignarle un tiempo máximo a una votación para recibir los resultados en un tiempo limitado}
    ...
    \textbf{Descripción Detallada:} \\
    El creador de una votación en un grupo podrá asignarle un tiempo máximo para que el resto de usuarios del grupo voten. Pasado ese tiempo, se cerrará automaticamente la votación anunciándose el ganador.
...
%12
\begin{hu_card}{12}{Como cliente quiero poder eliminar una votación para cancelar una decisión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 25\\
        \textbf{Estimación:}  & 1 PH \\
    ...
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item La votación y todos sus datos asociados se borran de la base de datos.
        \item Solo puede eliminar la votación el creador de la misma.
    \end{enumerate}
\end{hu_card}

%13
\begin{hu_card}{13}{Como cliente quiero poder ver las votaciones activas en los grupos a los que pertenezco para poder votar en ellas}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 26\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \textbf{Tareas:}
    \begin{itemize}[noitemsep, topsep=0pt]
        \item Mostrar las votaciones que no hayan finalizado en la interfaz de un grupo.
    \end{itemize}
...
%14
\begin{hu_card}{14}{Como cliente quiero poder votar en las votaciones para tener derecho de elección}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 27\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \textbf{Descripción Detallada:} \\
    Un cliente perteneciente a un grupo podrá votar en las votaciones activas del grupo. Guardandose su voto y teniéndolo en cuenta en la elección del ganador.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Cuando se hayan registrado los votos de todos los miembros se cerrará la votación.
        \item El voto será almacenado en la base de datos relacionando la opción votada, el cliente y la votación.
    \end{enumerate}
\end{hu_card}

%15
\begin{hu_card}{15}{Como cliente quiero poder añadir opciones a una votación para poder votarlas posteriormente}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 23\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \textbf{Descripción Detallada:} \\
    Los miembros de un grupo podrán sugerir opciones durante el proceso de creación de una votación. Esas opciones, serán añadidas como posibles opciones votables una vez configurada completamente una votación.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Solo los usuarios miembros de un grupo podrán sugerir opciones.
        \item La interfaz de opciones de la votación se actualiza mostrando la nueva creada.
    \end{enumerate}
\end{hu_card}

%16
\begin{hu_card}{16}{Como cliente quiero poder elegir el tipo de votación para adaptarlo a mis necesidades}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 22\\
        \textbf{Estimación:}  & 4 PH \\
...
\begin{hu_card}{17}{Como cliente quiero ver las decisiones pasadas para recordar las elecciones tomadas}
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item No se muestran votaciones que no pertenezcan al cliente.
    \end{enumerate}
\end{hu_card}5

%18
\begin{hu_card}{18}{Como cliente quiero ver la opción ganadora en una votación para conocer la decisión final}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 28\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Solo se avisa a los usuarios pertenecientes a la votación de la opción ganadora.
    \end{enumerate}
\end{hu_card}

%19
\begin{hu_card}{19}{Como cliente quiero poder seleccionar decisiones predeterminadas para facilitar mi toma de decisiones}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 29\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \textbf{Descripción Detallada:} \\
    Los clientes podrán seleccionar desde un grupo o desde su cuenta personal decidir usando como plantilla las elecciones predeterminadas que ofrece la aplicación.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Las votaciones predeterminadas se comportarán de la misma forma que una votación normal.
    \end{enumerate}
\end{hu_card}

%20
\begin{hu_card}{20}{Como cliente quiero poder subir imágenes a la aplicación para usarlas en las opciones o como foto de perfil o grupo}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 16\\
        \textbf{Estimación:}  & 1 PH \\
...
%21
\begin{hu_card}{21}{Como administrador quiero poder crear otro administrador para que me ayude en las tareas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 2\\
        \textbf{Estimación:}  & 2 PH \\
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá crear otro administrador para el sistema. Para ello, tendrá que cambiar el rol asociado de otro usuario de cliente a administrador.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item El nuevo administrador accede al sistema con las opciones de administrador.
    \end{enumerate}
\end{hu_card}

%22
\begin{hu_card}{22}{Como administrador quiero poder eliminar a otro administrador para revocar sus permisos de administración}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 9\\
        \textbf{Estimación:}  & 1 PH \\
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá cambiarle el rol a otro usuario de administrador a cliente.
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item El rol del usuario se cambia en la base de datos.
        \item El antiguo administrador accede al sistema con las opciones de cliente.
    \end{enumerate}
\end{hu_card}

%23
\begin{hu_card}{23}{Como administrador quiero poder editar mi perfil para modificar mis datos}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 10\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ2 y REQ9 \\
    \end{tabularx}
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá cambiar los datos asociados a su cuenta.

    \vspace{2mm}
    \textbf{Tareas:}
    \begin{itemize}[noitemsep, topsep=0pt]
        \item Crear la interfaz de edición de la cuenta.
...
%24
\begin{hu_card}{24}{Como administrador quiero poder iniciar sesión en la aplicación para hacer tareas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 5\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ23 \\
    ...
    \textbf{Descripción Detallada:} \\
    Permitirá a un administrador entrar en la aplicación en el modo administrador con los datos de la cuenta que tiene asociada en el sistema.
...
%25
\begin{hu_card}{25}{Como administrador quiero poder cerrar sesión en la aplicación para que nadie más pueda acceder a mi cuenta}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 6\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ23 \\
    ...
    \textbf{Descripción Detallada:} \\
    El administrador podrá cerrar en un dispositivo la sesión asociada a su cuenta del sistema.
...
%26
\begin{hu_card}{26}{Como administrador quiero poder modificar los datos de un usuario para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 17\\
        \textbf{Estimación:}  & 1 PH \\
...
%27
\begin{hu_card}{27}{Como administrador quiero poder modificar datos de un grupo para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 18\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ9 \\
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item Si se supera el número máximo de miembros pertenecientes a un grupo, se cancelará la inserción y se avisará mediante un error.
        \item Si se elimina el último miembro que formaba parte del grupo se elimina automáticamente el grupo y sus datos asociados.
    \end{enumerate}
\end{hu_card}

%28
\begin{hu_card}{28}{Como administrador quiero poder modificar datos de una votación para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 30\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ9 \\
...
%29
\begin{hu_card}{29}{Como administrador quiero poder eliminar un usuario para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 19\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ9 \\
    ...
    \begin{itemize}[noitemsep, topsep=0pt]
        ...
        \item Borrar los datos asociados al usuario del sistema.
    \end{itemize}

    \vspace{2mm}
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item Se eliminan los datos del usuario correspondiente y sus datos asociados de la base de datos.
        \item Se actualizan las interfaces dejando de mostrar a ese usuario.
    \end{enumerate}
\end{hu_card}

%30
\begin{hu_card}{30}{Como administrador quiero poder eliminar un grupo para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 20\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ9 \\
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá eliminar un grupo y sus datos asociados.

    \vspace{2mm}
    \textbf{Tareas:}
    \begin{itemize}[noitemsep, topsep=0pt]
        \item Crear el botón de borrado del grupo.
        \item Borrar el grupo y todos sus datos asociados de la base de datos.
    \end{itemize}

    \vspace{2mm}
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item Se elimina el grupo y sus datos asociados de la base de datos.
        \item Se actualiza la interfaz dejando de aparecer ese grupo.
    \end{enumerate}
\end{hu_card}

%31
\begin{hu_card}{31}{Como administrador quiero poder eliminar una votación para solucionar problemas de gestión}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 31\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ9 \\
...
%32
\begin{hu_card}{32}{Como administrador quiero poder realizar las tareas de un cliente para comprobar posibles errores en la aplicación}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 11\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ2, REQ3, REQ4, REQ5, REQ10, REQ11, REQ12, REQ14, REQ 15, REQ16, REQ17, REQ18, REQ19, REQ20, REQ21 y REQ23 \\
    \end{tabularx}
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá acceder a todas las funcionalidades de las que dispone un cliente, con el objetivo de moderar y descubrir errores en la aplicación.

    \vspace{2mm}
    \textbf{Tareas:}
    \begin{itemize}[noitemsep, topsep=0pt]
        \item Concederle a un administrador todos los permisos y funcionalidades de las que dispone un cliente.
        \item Mostrar en la interfaz de administrador las opciones de las que dispone un cliente.
    \end{itemize}

    \vspace{2mm}
    \textbf{Pruebas de Validación (Criterios de Aceptación):}
    \begin{enumerate}[noitemsep, topsep=0pt]
        \item El administrador posee en su interfaz las mismas opciones que un cliente.
        \item El administrador puede realizar las mismas funciones que un cliente.
    \end{enumerate}
\end{hu_card}
