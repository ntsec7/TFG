...
\begin{hu_card}{9}{Como cliente quiero poder eliminar miembros de un grupo para que dejen de formar parte del grupo}
    ...
    \textbf{Descripción Detallada:} \\
    Un miembro de un grupo podrá eliminar a otro miembro del mismo, dejando de formar parte de él hasta que un usuario perteneciente al mismo volvierá a añadirlo. Al usuario eliminado dejará de salirle el grupo en la lista de grupos.
...
\begin{hu_card}{10}{Como cliente quiero poder iniciar una votación para tomar una decisión}
    ...
    \textbf{Descripción Detallada:} \\
    Un cliente podrá crear una votación de manera personal o en un grupo del que forma parte, siendo en este último caso la decisión pública para todos los miembros del grupo. La votación contará con un título, una lista de opciones y el tipo de votación.
...
\begin{hu_card}{15}{Como cliente quiero poder añadir opciones a una votación para poder votarlas posteriormente}
    ...
    \textbf{Descripción Detallada:} \\
    Los miembros de un grupo podrán sugerir opciones durante el proceso de creación de una votación. Esas opciones, serán añadidas como opciones que podrán votar cuando se publique la votación.
...
\begin{hu_card}{16}{Como cliente quiero poder elegir el tipo de votación para adaptarlo a mis necesidades}
    ...
    \begin{enumerate}[noitemsep, topsep=0pt]
        ...
        \item El ganador es elegido siguiendo los parámetros establecidos por el tipo de votación elegido.
    \end{enumerate}
\end{hu_card}
...
\begin{hu_card}{19}{Como cliente quiero poder seleccionar decisiones predeterminadas para facilitar mi toma de decisiones}
    ...
    \textbf{Descripción Detallada:} \\
    Los clientes podrán seleccionar desde un grupo o desde su cuenta personal crear una votación usando como plantilla las elecciones predeterminadas que ofrece la aplicación.
...
\begin{hu_card}{22}{Como administrador quiero poder eliminar a otro administrador para revocar sus permisos de administración}
    ...
    \textbf{Descripción Detallada:} \\
    Un administrador podrá eliminar a otro administrador del sistema. Eso se conseguirá cambiandole el rol al otro usuario de administrador a cliente.
...
\begin{hu_card}{32}{Como administrador quiero poder realizar las tareas de un cliente para comprobar posibles errores en la aplicación}
    \begin{tabularx}{\linewidth}{l X}
        \textbf{Prioridad:}   & 11\\
        \textbf{Estimación:}  & 1 PH \\
        \textbf{RF Relacionados:} & REQ2, REQ3, REQ4, REQ5, REQ10, REQ11, REQ12, REQ14, REQ 15, REQ16, REQ17, REQ18, REQ19, REQ20, REQ21, REQ23 y REQ24 \\
    \end{tabularx}
